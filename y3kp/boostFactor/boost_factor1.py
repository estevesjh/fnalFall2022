...
def execute(block, config):
    ...
    for L in l:
        for Z in z:
            ...
            Rs = block["Boost_Factor_Model_Values", "amp_Rs"]
            B0 = block["Boost_Factor_Model_Values", "amp_B0"]
            ...
            rslog, b0log = Boost_factor_util.Boost_Factor_log_param(Z,L,Rs,alpha_Rs,beta_Rs,B0,alpha_B0,beta_B0)
